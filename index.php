...
<!DOCTYPE html>
 ...
 <head>
 	...
 	<style>
 		.box{border: 1px solid #999;margin: 30px auto 0;padding: 20px;width: 1000px;height: 250px;overflow: scroll;}
 ...
 <body">
 	...
 	<div class="box">
 		<ul>
 			<?php 
 			 ...
 			 ?>
 			<li><b style="color:#333"><?php echo $data['name']; ?><b>  -  <?php echo $com->dateFormat($data['comment_time']); ?> <br>	 <h3><?php echo $data['comment'] ?></h3></li>
 			<?php } ?>
 		</ul>
 	</div><br><br>
 	<center>
	...
	<div style="border-style: groove;width: 50%;height: 280px">
